...
<form method="POST" action="/bmgcsv/v1/tocsv" enctype="multipart/form-data">
...
<div class="text-center mt-2"><a href="/bmgcsv" class="text-decoration-none">To a NEW version</a></div>

{:else if page=="c2b"}
<h1 class="text-center">CSV TO WBMGT</h1>

<form method="POST" action="/bmgcsv/v1/totxt" enctype="multipart/form-data">
    <div class="input-group">
